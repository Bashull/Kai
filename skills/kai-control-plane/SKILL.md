...
Use `kai_control_plane.py` as the single operational entrypoint over memory, boot, capability registry, placement policy, evidence and authoring. It orchestrates proven tools; it must not duplicate their logic or bypass guardrails.
