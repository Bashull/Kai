...
from .catalog import ace_step_local_target, minimax_music_api_target, suno_platform_target
...
__all__ = [
    ...
    "ace_step_local_target", "minimax_music_api_target", "suno_platform_target",
